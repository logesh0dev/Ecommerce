...
<div class="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <p class="text-gray-600">Your email address is <strong>morrisonlokesh@gmail.com</strong></p>
      ...
      <div class="flex ">
        ...
        </svg> */}Do you want to change the Password &nbsp;
        <button class="inline-flex text-sm text-right font-semibold text-blue-600 underline decoration-2"> Change</button>
      ...
      {/* <button class="mt-4 cursor-pointer items-center justify-center rounded-md bg-slate-900 px-4 py-3 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all active:scale-90">Save Password</button> */}
      <hr class="mt-4 mb-8" />
